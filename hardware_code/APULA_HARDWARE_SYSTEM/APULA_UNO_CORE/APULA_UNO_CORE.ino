...
{ 
  ...
  if(!fireDetected) { 
    ...
    for(pos = 0; pos <= 180; pos++) { 
      smallServo1.write(pos);       // Sensor 1: Left to Right (0 -> 180)
      smallServo2.write(180 - pos); // Sensor 2: Right to Left (180 -> 0)
      delay(20); 
    ...
    for(pos = 180; pos >= 0 && !fireDetected; pos--) { 
      smallServo1.write(pos);       // Return scan
      smallServo2.write(180 - pos); // Return scan
      delay(20); 
